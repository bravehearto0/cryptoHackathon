...
contract Token is StandardToken {
    ...
    string public constant name = 'Pokemon';                         // Set the token name for display
    string public constant symbol = 'POKM';                              // Set the token symbol for display

    // SUPPLY
    uint8 public constant decimals = 0;                               // Set the number of decimals for display
    uint256 public constant initialSupply = 1000000000;                 // OceanToken total supply
